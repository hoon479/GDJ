...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		// 대입 연산
		int score = 100; // 등호(=)가 대입 연산이다.
		System.out.println(score);
		
		// 연습
		// x에 10이 있고, y에 20이 있다.
		// x와 y에 저장된 값을 서로 교환 하시오.
		int x = 10;
		int y = 20;
		int temp;
		...
		//balance= balance *1.05; 실패 balance * 1.05 결과는 double이기 때문에 long balance에서 저장할 수 없다.
		//balance = (long)(balance *1.05); 성공 balance * 1.05 결과를 long으로 casting해서 저장할 수 있다.		
		
		//balance = balance +balance * 0.05; // balance +S 
