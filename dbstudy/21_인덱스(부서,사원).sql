...
-- 인덱스 칼럼 조회
-- 사용자가 작성한 인덱스가 동작하는 칼럼 확인은 USER_IDN_COLUMNS
...
/*
   CODE는 PK이고, VARCHAR2 타입입니다.
   WHERE CODE = 1 (동작함)
   WHERE TO_NUMBER(CODE) = 1 (내부 동작)
   TO_NUMBER() 함수로인해 CODE의 인덱스를 사용할수 없음
